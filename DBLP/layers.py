...
#        stdv5 = 1. / math.sqrt(self.weight5.size(1))
        ...
        #self.weight.data.uniform_(-stdv, stdv)
        torch.nn.init.kaiming_uniform_(self.weight0)
#        torch.nn.init.kaiming_uniform_(self.weight3)
        torch.nn.init.kaiming_uniform_(self.weight2)
        torch.nn.init.kaiming_uniform_(self.weight1)
        torch.nn.init.kaiming_uniform_(self.weight3)
        torch.nn.init.kaiming_uniform_(self.weight4)
#        torch.nn.init.kaiming_uniform_(self.weight5)
