...
parser.add_argument('--hid1', type=int, default=9,
                    help='Number of hidden units.')
parser.add_argument('--hid2', type=int, default=30,
                    help='Number of hidden units.')
...
parser.add_argument('--sct_inx1', type=int, default=1, help='scattering index1')
parser.add_argument('--sct_inx2', type=int, default=3, help='scattering index2.')
...
scheduler = MultiStepLR(optimizer, milestones=[10], gamma=0.9)
if args.cuda:
    model.cuda()
...
def test():
    ...
    print('sct_inx1: %d, sct_inx2: %d'%(args.sct_inx1,args.sct_inx2))
...
# Testing
test()
np.savetxt('sct_accu_list.txt',accu_list)
np.savetxt('sct_time_list.txt',time_list)
